...
# Publications
 - DiSpirito, JR, Badur, MG, **Camacho, DM**, Chalishazar, A, DeChristopher, B, Sellers, K, Steadman, M, Soh, K, Monroe, J, Long, A (2021), Allosteric Inhibition of MALT1 Is Efficacious in a Model of Chronic Graft-Versus-Host Disease and Modulates Immunometabolic Activation, _Blood_, 138, 3810
 - Gazzaniga, FS, **Camacho, DM**, Wu, M, Palazzo, MFS, Dinis, ALM, Grafton, FN, Cartwright, MJ, Super, M, Kasper, DL, Ingber, DE (2021), Harnessing Colon Chip technology to identify commensal bacteria that promote host tolerance to infection, _Frontiers in Cellular and Infection Microbiology_, 11, 105
 - Sperry, MM, Novak, R, Keshari, V, Dinis, ALM, Cartwright, MJ, **Camacho, DM**, Paré, JF, Super, M, Levin, M, Ingber, DE (2021), Enhancers of host immune tolerance to bacterial infection discovered using linked computational and experimental approaches, _bioRxiv_
