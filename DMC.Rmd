...
# Technical Skills
Machine learning, deep learning, multi omics data analytics, R/Bioconductor, python. Adept user of OS X/macOS, Unix. Familiarity with cloud computing architectures (AWS) and high performance computing environments.
...
Led a team of 15 computational biologists, machine learning scientists, and data analysts, to drive the discovery of novel chemical entities that can modulate cell behavior phenotypes. Some of the functions associated with the role include: 

 - Implementation of Computational Biology and Machine Learning strategy within the company, working closely with C-level executives
...
Led Computational Biology and Bioinformatics group at Rheos Medicines, focusing on advancing Rheos' Precision Medicine platform, developing tools and capabilities to integrate multi-omics data that are fed into machine learning algorithms for patient stratification, target identification, and biomarker discovery. Some of the functions associated with the role: 

 - Implementation of Computational Biology and Bioinformatics strategy within the company
 - Management of team activities in line with cross-functional teams needs as well as development of internal capabilities to advance the Computational Biology and Bioinformatics function
 - Managing the development of the Machine Learning and Deep Learning capabilities at Rheos through internal advancement or through collaborations with external partners
 - Managing Computational Biology CRO engagement and deliverables
...
As the group lead of the Predictive BioAnalytics Initiative at the Wyss Institute, I led a team of computational biologists, computer scientists, and software engineers to address challenges in machine learning and biomedical data sciences, both in-house or thtough external collaborations. Some of the functions associated with the role included:

 - Development and implementation of research strategy for the Initiative, focusing on enabling ML/DL/AI capabilities
...
# Publications
 - Valeri, JA, Soenksen, LR, Collins, KM, Ramesh, P, Cai, G, Powers, R, Angenent--Mari, NA, **Camacho, DM**, Wong, F, Lu, TK, Collins, JJ (2023), BioAutoMATED: An end-to-end automated machine learning tool for explanation and design of biological sequences, _Cell Syst_, 14, 525 [[PubMed](https://pubmed.ncbi.nlm.nih.gov/37348466/)]
