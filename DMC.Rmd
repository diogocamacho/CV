...
Highly effective and experienced executive in Computational System Biology and Machine Learning. Extensive experience in biotech/pharma in the development and implementation of computational tools for multi omics data analysis, drug discovery, and target identification. I am interested in the application of computational toolsin the drug discovery, disease biology characterization, large data analytics for biology, while focusing on bridging the gap between the wet and dry labs through highly engaging and fruitful collaborations.
...
# Patents
 - Novak, R, Jalili-Firoozinezhad, S, Gazzaniga, FS, Calamari, EL, **Camacho, DM**, Nestor, BA, Fadel, C, Cronce, ML, Kasper, DL, Ingber, DE, Bein, A, Complex Human Gut Microbiome Cultured in an Anaerobic Human Gut-on-A-Chip, US20240002808A1 (2023)
 ...
 - Collins, JJ, Belenky, P, **Camacho, DM** (2015), Compositions and methods for treating fungal infections, WO2014130922A1
