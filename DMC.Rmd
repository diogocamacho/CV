...
I currently lead the Computational Biology and Bioinformatics group at Rheos Medicines. The group is focused on advancing Rheos' Precision Medicine platform, developing tools and capabilities to integrate multi-omics data that are fed into machine learning algorithms for patient stratification, target identification, and biomarker discovery. Some of the functions associated with the role: 
